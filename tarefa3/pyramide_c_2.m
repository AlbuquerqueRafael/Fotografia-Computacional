...
im_left = im2double(imread('day_and_night/paris.jpg'));
mask0 = im2double(imread('day_and_night/protest_mask.jpg'));
im_right = im2double(imread('day_and_night/storm.jpg'));
