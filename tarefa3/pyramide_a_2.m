...
im_left  = im2double(imread('day_and_night/night1.jpg')); 
im_right = im2double(imread('day_and_night/sun_resize.jpg')); 
mask0    = im2double(imread('day_and_night/sun_mask_resize.jpg')); 
