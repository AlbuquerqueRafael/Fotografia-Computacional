...
im_left  = im2double(imread('day_and_night/park.jpg')); 
im_right = im2double(imread('day_and_night/cachorro_resize.jpg')); 
mask0    = im2double(imread('day_and_night/dog_mask_resize.jpg')); 
